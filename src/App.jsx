...
const T = {
  en: {
    ...
    housingConfirmed: "Yes — dorm, rental, or homestay",
    housingTemp: "Not yet — hotel, Airbnb, or searching",
  ...
  ja: {
    ...
    housingConfirmed: "はい — 寮・賃貸・ホームステイ",
    housingTemp: "まだ — ホテル・Airbnb・探し中",
      ...
      tasks: [
        ...
        },
        {
          ...
          why: L({
            ...
            ja: "マイナンバーカードは日本の電子IDカード。健康保険証として使えるほか、入管への申請をオンラインで行える。有効期限は在留期間の満了日まで。",
          }),
