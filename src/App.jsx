    ...
    },
    {
      ...
      tasks: [
        ...
        },
        {
          ...
          location: "City Hall — My Number window or online via Mynaportal",
          required: ["Individual number notification letter — arrives by registered mail 2–3 weeks after your moving-in notification; not valid as ID", "Passport", "Photo via a certificate photo app"],
